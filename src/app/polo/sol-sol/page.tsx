...
export default function PoloSolSol() {
  const modulos: ModuloData[] = [{ id: 'm1-1', tag: 'Módulo I — Básico', dias: '2ª e 4ª-feira', horario: '08h30 às 10h00', formUrl: 'LINK_FORM_SOLSOL_M1_24' }]
